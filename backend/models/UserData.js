...
const userDataSchema = new mongoose.Schema({
  ...
  goalTasks:    { type: mongoose.Schema.Types.Mixed, default: {} },
  goalNotes:    { type: mongoose.Schema.Types.Mixed, default: {} },
  goalReminders:{ type: mongoose.Schema.Types.Mixed, default: {} },
  ...
  waterTracker: { type: mongoose.Schema.Types.Mixed, default: { glasses: [], reminders: [], dailyTarget: 8 } },
  medicineTracker: { type: mongoose.Schema.Types.Mixed, default: { medicines: [], logs: [] } },
  upcomingTimeline: { type: mongoose.Schema.Types.Mixed, default: [] },
